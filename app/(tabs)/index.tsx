      ...
      <SafeAreaView className="flex-1 px-5">
        ...
        <View className="pt-2 flex-row items-center justify-between">
          <View className="flex-row items-center">
            ...
            <Text className="text-2xl font-extrabold text-green-700">EcoMotion</Text>
          </View>
        ...
        {/* Points card */}
        <View className="mt-4 rounded-3xl p-5 bg-green-600">
          <View className="flex-row items-center justify-between">
            <View>
              <Text className="text-white/80">Your Points</Text>
              <Text className="text-white text-4xl font-extrabold mt-1">{points}</Text>
            </View>
            <Image
              source={{
          ...
          <View className="flex-row gap-3 mt-4">
            <View className="flex-1 rounded-2xl bg-white/15 p-3">
              ...
              <Text className="text-white font-bold text-xl mt-0.5">{streakDays} days</Text>
            </View>
            <View className="flex-1 rounded-2xl bg-white/15 p-3">
              <Text className="text-white/80">CO₂ Saved</Text>
              <Text className="text-white font-bold text-xl mt-0.5">{co2SavedKg} kg</Text>
            </View>
          </View>
        </View>
